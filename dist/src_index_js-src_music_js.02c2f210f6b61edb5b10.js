 ...
 */
(self["webpackChunkthree_shader_env01"] = self["webpackChunkthree_shader_env01"] || []).push([["src_index_js-src_music_js"],{
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _blob_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./blob.js */ \"./src/blob.js\");\n/* harmony import */ var _index_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./index.js */ \"./src/index.js\");\n/* harmony import */ var _start_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./start.js */ \"./src/start.js\");\n/* harmony import */ var _assets_videos_143_BPM120_mp3__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./assets/videos/143_BPM120.mp3 */ \"./src/assets/videos/143_BPM120.mp3\");\n\n\n\n\n\nconst musicOnButton = document.getElementById('music-on');\nconst musicOffButton = document.getElementById('music-off');\nlet audio = new Audio(_assets_videos_143_BPM120_mp3__WEBPACK_IMPORTED_MODULE_3__);\naudio.loop = true;\n\n// 初期のブロブ色を設定\n(0,_blob_js__WEBPACK_IMPORTED_MODULE_0__.animateBlobs)();\n(0,_blob_js__WEBPACK_IMPORTED_MODULE_0__.heyMelody)();\n(0,_index_js__WEBPACK_IMPORTED_MODULE_1__.disableScroll)();\nconst isPlaying = localStorage.getItem('isPlaying') === 'true';\nif (isPlaying) {\n  audio.play();\n}\n\n// 音楽ONボタンの処理\nmusicOnButton.addEventListener('click', () => {\n  audio.play();\n  // 音楽再生画面を非表示にする\n  document.querySelector('.container').style.display = 'none';\n  setInterval(() => {\n    // audio.currentTimeで現在の再生位置（秒数）を取得し、localStorageに保存\n    localStorage.setItem('currentPosition', audio.currentTime.toString());\n  }, 10000); // 例えば1秒ごとに更新\n\n  (0,_start_js__WEBPACK_IMPORTED_MODULE_2__.loader)();\n  (0,_index_js__WEBPACK_IMPORTED_MODULE_1__.enableScroll)();\n});\n\n// 音楽OFFボタンの処理\nmusicOffButton.addEventListener('click', () => {\n  if (!audio.paused) {\n    audio.pause();\n    audio.currentTime = 0; // 再生位置を最初に戻す\n  }\n  // 音楽再生画面を非表示にする\n  document.querySelector('.container').style.display = 'none';\n  localStorage.setItem('isPlaying', 'false');\n  (0,_start_js__WEBPACK_IMPORTED_MODULE_2__.loader)();\n  (0,_index_js__WEBPACK_IMPORTED_MODULE_1__.enableScroll)();\n});\n\n//# sourceURL=webpack://three-shader-env01/./src/music.js?");
...
/***/ "./src/assets/videos/143_BPM120.mp3":
/*!******************************************!*\
  !*** ./src/assets/videos/143_BPM120.mp3 ***!
  \******************************************/
...
"use strict";
eval("module.exports = __webpack_require__.p + \"videos/143_BPM120.mp3\";\n\n//# sourceURL=webpack://three-shader-env01/./src/assets/videos/143_BPM120.mp3?");
